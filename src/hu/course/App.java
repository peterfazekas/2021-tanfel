...
public class App {
    ...
    private void run() {
        ...
        System.out.println("A fájlban "
                + courseService.getCourseCount() +" bejegyzés van.");
        System.out.println("3. feladat:");
        System.out.println("Az iskolában a heti összóraszám: "
                + courseService.getTotalLessonCount());
        System.out.println("4. feladat:");
        System.out.print("Egy tanár neve: ");
        String name = console.read();
        System.out.println("A tanár heti óraszáma: "
                + courseService.getTeacherWeeklyLesson(name));
        ...
        System.out.println(courseService.getCourseStatus(subject, classId));
